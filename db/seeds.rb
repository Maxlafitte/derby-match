...
user_3 = User.create!(email: 'breaking@bear.com', password: 'azerty', derby_name: 'Breaking Bears Stitches')
user_4 = User.create!(email: 'bunnies@lrg.com', password: 'azerty', derby_name: 'Tequila Sheila')
...
user_13 = User.create!(email: 'atlantic_breakers_a@cornwall.com', password: 'azerty', derby_name: 'Meanhatten')
user_14 = User.create!(email: 'atlantic_breakers_b@cornwall.com', password: 'azerty', derby_name: 'Unholy Roller')
user_15 = User.create!(email: 'all_stars@stockholm.com', password: 'azerty', derby_name: 'One Hit Wonder')
user_16 = User.create!(email: 'bstrds@stockholm.com', password: 'azerty', derby_name: 'Stockholm Lady Liberty', remote_photo_url: avatar_2)
user_17 = User.create!(email: 'c_star@stockholm.com', password: 'azerty', derby_name: 'Stockholm Long Arm Lolita')
user_18 = User.create!(email: 'sisters@liverpool.com', password: 'azerty', derby_name: 'Zombie')
user_19 = User.create!(email: 'yellow_shovemarines@liverpool.com', password: 'azerty', derby_name: 'Brawllipop')
user_20 = User.create!(email: 'c_team@liverpool.com', password: 'azerty', derby_name: 'Beware of Bitch')
